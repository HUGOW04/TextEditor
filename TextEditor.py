...
from turtle import Screen, title, window_height
...
def about():
    showinfo("About this program","This is a simple text editor that you can write inside")
...
color_buttom = Button(frame,text="color",command=change_color)
color_buttom.grid(row=0,column=0)
